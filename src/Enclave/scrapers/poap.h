...
//
#ifndef SRC_ENCLAVE_SCRAPERS_POAP_H_
#define SRC_ENCLAVE_SCRAPERS_POAP_H_
...
class PoapScraper : Scraper {
 public:
  err_code handle_long_resp(const char *data, size_t len, char *resp_data) final;
 private:
};

const string POAP_HASH_PREFIX = string("\x19") + "Ethereum Signed Message:\n52candidNFT:0x";

const std::set<string> POAP_LIST = {
  "006a8a496889e9983A5256F34B608Ee9569ba319",
  "bd7d04823e8a79b6831725b26d2d147efbfe24c6",
  "a39871ab5277194e76a944f864a73ee40ed07279",
};



#endif  // SRC_ENCLAVE_SCRAPERS_POAP_H_
